            ...
            <div class="container">
                ...
                <div class="sect1__company_history">
                    ...
                    <div class="sect1__company_history--content">
                        <div class="row-1">
                            <img src="<?php echo get_template_directory_uri(); ?>/release/image/history/company_img-1.png" alt="">
                        </div>
                        <div class="row-2">
                ...
                <div class="sect1__company_history">
                    ...
                    <div class="sect1__company_history--content">
                        <div class="row-1">
                            <img src="<?php echo get_template_directory_uri(); ?>/release/image/history/company_img-2.png" alt="">
                        </div>
                        <div class="row-2">
