...
<div id="PWP">
    ...
    <section class="flex">
        <div class="container">
            <h2 class="title">魅力.1　未体験の画質</h2>
            <div class="flex__content">
                <div class="column flex__content--column_small">
                    <p class="ttl mb-20">プリントを透過光で見る新しさ</p>
                    <p class="description">
    ...
    <section class="sect_comparison">
        <div class="container">
            <div class="sect_comparison__text">
                <h3 class="sect_comparison--ttl">比べたら一目瞭然。<br>色のコクと透明感の両立、見たままの立体感・質感の描写。</h3>
                <p class="sect_comparison--desc">（比較の表現はイメージです）</p>
            </div>
            <div class="flex">
                <div class="column">
    ...
    <section class="sect_comparison">
        <div class="container">
            <div class="sect_comparison__text">
                <h3 class="sect_comparison--ttl">カメラで捉えていた黒と白の階調。<br>モノクロ作品も今までにない表現力。</h3>
                <p class="sect_comparison--desc">（比較の表現はイメージです）</p>
            </div>
            <div class="flex">
                <div class="column">
    ...
    <section class="flex">
        <div class="container">
            <h2 class="title">魅力.2　新感覚の楽しさ</h2>
            <div class="flex__content">
                <div class="column flex__content--column_small">
                ...
                <div class="column flex__content--column_small">
                    <div class="mt-100">
                        ...
                        <ul class="description">
                            <li><span>・</span>窓辺で光を浴びて楽しむ</li>
                            <li><span>・</span>カフェカーテン代わりにも</li>
                            <li><span>・</span>カーテンレールから吊り下げる</li>
                        </ul>
                    </div>
                </div>
                <div class="column flex__content--column_large">
    ...
    <section class="flex">
        <div class="container">
            <div class="flex__content flex-reverse">
                ...
                <div class="column flex__content--column_small">
                    <div class="mt-100">
                        <p class="ttl mb-20">屋外でも写真展！？</p>
                        <ul class="description">
                            <li><span>・</span>木漏れ日が射し込む森の中で</li>
                            <li><span>・</span>プールサイドなどでも</li>
                        </ul>
                    </div>
                </div>
    ...
    <section class="flex">
        <div class="container">
            <div class="flex__content">
                <div class="column flex__content--column_small">
                    <div class="mt-100">
                        <p class="ttl mb-20">ビジネスシーンで…</p>
                        <ul class="description">
                            <li><span>・</span>窓ガラスに貼って集客力を高めるPOPとして</li>
                        </ul>
                    </div>
                </div>
                <div class="column flex__content--column_large">
    ...
    <section class="sect_comparison">
        <div class="container">
            ...
            <div class="flex flex__content about-size">
                <div class="column">
                    <div class="column-content mb-60">
                        <p class="ttl mb-20">サイズについて</p>
                        <ul class="description">
                            <li><span>・</span>A2サイズまたはA3サイズの2種からお選びいただけます。</li>
                            <li><span>・</span>プリント幅は48cmで、長さはお好みの長さでプリントできます。
                                バナー（幅50cm×天地200cm) など、ロングタイプの写真プリントも楽しめます。</li>
                        </ul>
                    </div>
                    <div class="column-content mb-60">
                        <p class="ttl mb-20">個展やグループ展で</p>
                        <ul class="description">
                            <li><span>・</span>プリント幅は48cmで、長さはお好みの長さでプリントできます。
                                バナー（幅50cm×天地200cm) など、ロングタイプの写真プリントも楽しめます。</li>
                            </li>
                    ...
                    <div class="column-content mb-60">
                        <p class="ttl mb-20">POPや販促物にも</p>
                        <ul class="description">
                            <li><span>・</span>カフェのウインドウを飾ったり、スタイリッシュなPOPとしても効果抜群です。デザインも合わせて承ります。</li>
                            </li>
                        </ul>
                    </div>
                </div>
